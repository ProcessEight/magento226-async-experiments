...
namespace ProcessEight\GetProductsAsync\Model;

use ProcessEight\GetProductsAsync\Api\TimerInterface;
use ProcessEight\GetProductsAsync\Exception\TimerException;

/**
 * Class Timer
 *
 * @package ProcessEight\GetProductsAsync\Model
 */
